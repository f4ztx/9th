                ...
                {services.map((service, index) => {
                  ...
                  <div key={index} className={`group ${positionClass}`}>
                    <div className="relative">
                      ...
                      {/* Main Card */}
                      <div
                        className={`relative ${service.bgColor} dark:bg-gray-800 border-2 border-[#2A3C50]/20 dark:border-white/20 p-8 rounded-xl transition-all duration-500 group-hover:translate-x-0.5 group-hover:-translate-y-0.5`}
                      >
